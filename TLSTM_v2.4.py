...
class TLSTM(object):
    ...
    def train(self, epoch=10):
        ...
        num_sample = int(27330) # total samples
        ...
        with tf.Session() as sess:
            ...
            for one_epoch in range(epoch):
                ...
                for oneepoch_data in data_loader(32):
                    ...
                    print("---------------------------step" + str(step) + "-------loss" + str(mae))
                    # print ("---------------y" + str(__y))
                ...
                print("---------------------------Loss mae" + str(float(mean_loss/(num_sample*split/self._batch_size))))      
                print("---------------------------Loss spearman" + str(scipy.stats.spearmanr(self.all_prediction,self.all_y)[0]))
                # print(step,"")
            merged = tf.summary.merge_all()
            # tf.summary.FileWriter()将所有信息写入文件
            writer = tf.summary.FileWriter('./tensorflow1.1_logs', sess.graph)
